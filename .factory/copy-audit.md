...
| Get timings, size movement, and rollback status. | 7 | — |
| It does not connect to production. | 6 | — |
| It does not copy data. | 5 | — |
| It does not author migrations. | 5 | — |
| Results are estimates from a disposable environment. | 7 | — |
| Start with `mlr demo`. | 4 | — |
...
| Decision document | go/no-go card |
| Reversal SQL | rollback |
| Generated operator document | runbook |
